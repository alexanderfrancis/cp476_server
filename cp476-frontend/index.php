    ...
    <div class="heading">
      <div class="navbar">
        <ul class="navbar-list">
          ...
          <div class="navbar-categories">
            <li class="navbar-item">
              <a href="./product-pages/all.php">all</a>
            </li>
            <li class="navbar-item">
              <a href="./product-pages/casual.php">casual</a>
            </li>
            <li class="navbar-item">
              <a href="./product-pages/running.php">running</a>
            </li>
            <li class="navbar-item">
              <a href="./product-pages/boots.php">boots</a>
            </li>
          </div>

          <div class="navbar-options">
            <li class="navbar-item">
              <a class="navbar-item-container" href="./product-pages/signin.php">
                <svg class="navbar-item--icon">
      ...
      <div class="header">
        ...
        <button class="header-btn">
          <a href="./product-pages/all.php">Shop Shoes</a>
        </button>
      </div>
    </div>
  </body>
